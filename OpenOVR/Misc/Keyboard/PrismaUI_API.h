...
namespace PRISMA_UI_API
{
	...
	// Note: PluginHandle and ActorHandle are SKSE/CommonLib types not available
	// in OpenComposite's build environment. They are not used by any IVPrismaUI1
	// functions we call, so we define them as plain integer types here.
